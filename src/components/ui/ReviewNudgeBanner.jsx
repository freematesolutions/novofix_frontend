...
export default function ReviewNudgeBanner({ onReviewClick }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-yellow-50 via-amber-50 to-yellow-50 border border-amber-200/60 p-3 sm:p-5 shadow-sm">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center gap-3">
        {/* Star icon */}
        <div className="shrink-0 w-10 h-10 rounded-xl bg-amber-100 hidden sm:flex items-center justify-center">
        ...
        {/* Text content */}
        <div className="flex-1 min-w-0 flex items-start gap-2 sm:block">
          <div className="shrink-0 w-8 h-8 rounded-lg bg-amber-100 flex items-center justify-center sm:hidden">
        ...
        {/* Actions */}
        <div className="flex items-center gap-2 shrink-0 sm:ml-0 ml-0">
          <button
            onClick={() => { if (onReviewClick) onReviewClick(first.bookingId); }}
            className="flex-1 sm:flex-none px-3 py-1.5 text-xs font-semibold rounded-lg bg-amber-500 text-white hover:bg-amber-600 transition-colors shadow-sm"
          >
