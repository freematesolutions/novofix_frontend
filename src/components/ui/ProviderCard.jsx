          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 w-full">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3">
                ...
                {/* Response rate */}
                {responseRate > 0 && (
                  <div className="flex items-center gap-1.5 bg-brand-50 px-2.5 py-1.5 rounded-lg">
              ...
              <div className="flex flex-col gap-2 mt-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 flex-1 text-sm font-medium text-gray-600 hover:text-brand-600 transition-colors px-4 py-2.5 rounded-xl border border-gray-200 hover:border-brand-300 hover:bg-gray-50"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
