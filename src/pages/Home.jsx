  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      */}
      ...
      {/* Navegación flotante móvil - Solo para invitados (usuarios autenticados usan MobileBottomNav) */}
      {!searchResults && !selectedCategory && showFloatingNav && !isAuthenticated && (
